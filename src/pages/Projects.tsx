  ...
  const projects = [
    {
      ...
      description: "Modern analytics dashboard with real-time 3D data visualization, built with React and Three.js",
      image: project1,
    ...
    },
    {
      ...
      description: "Interactive shopping platform featuring 3D product previews and immersive user experience",
      image: project2,
    ...
    },
    {
      ...
      description: "Cross-platform mobile application with sleek UI and advanced animations",
      image: project3,
    ...
    {
      title: "AI/ML Visualization",
      description: "Interactive neural network visualizer with real-time data processing and 3D graphics",
      image: project4,
      tags: ["Python", "Three.js", "TensorFlow", "WebGL"],
      demoUrl: "#",
      githubUrl: "#",
    },
  ];
